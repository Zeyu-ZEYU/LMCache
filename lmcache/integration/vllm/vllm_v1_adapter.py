...
class _PrefillTimingRecorder:
    ...
    Stragglers are picked up on subsequent calls or at process exit
    ...
    def __init__(self, output_dir: str):
        ...
        # v0.3.9post1 has no LMCacheConnectorV1Impl.shutdown hook, so use
        # atexit to flush any in-flight events at process exit. Hooks at
        # every wait_for_save handle the steady-state case.
